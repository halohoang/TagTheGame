...
public class EnergyLauncher : BaseWeapon
{
    ...
    public EnergyLauncher(string weaponName, Enum_Lib.EWeaponType weaponType, float weaponDamage, float fireRate, int magazineSize, int currentRoundsInMag, int storedAmmo, int spawnedBullets, int reloadHintThreshold) 
