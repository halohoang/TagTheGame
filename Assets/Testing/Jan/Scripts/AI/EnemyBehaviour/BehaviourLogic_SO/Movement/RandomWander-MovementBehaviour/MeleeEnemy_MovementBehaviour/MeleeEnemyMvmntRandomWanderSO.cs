...
{
    [CreateAssetMenu(fileName = "MeleeEnemy_Mvmnt_RandomWander", menuName = "Scriptable Objects/Enemy Logic/Movement Logic/MeleeEnemy Random Wander")]    
    public class MeleeEnemyMvmntRandomWanderSO : BaseEnemyMovementSO
    {
        #region Events
        //--------------------------------
        // - - - - -  E V E N T S  - - - - 
