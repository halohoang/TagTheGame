...
public class AnyStateAnimation : MonoBehaviour
{
	...
	internal void SetAnimation(Animator animator, string triggerParameterToSet)
	{
		
	}

    internal void SetAnimation(Animator animator, string boolParameterToSet, bool bollianValue)
    {
